export function IconTrophy({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
      <path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6M18 9h1.5a2.5 2.5 0 0 0 0-5H18M6 4h12v5a6 6 0 0 1-12 0V4z" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 15v3M8 21h8M10 18h4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}

export function IconScoreboard({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
      <rect x="3" y="4" width="18" height="14" rx="2" />
      <path d="M7 9h4M7 13h2M13 9h4M13 13h2" strokeLinecap="round" />
    </svg>
  )
}
...
export function IconShare({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
      <path d="M4 12v7a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7M16 6l-4-4-4 4M12 2v13" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
...
export function IconBall({ className = 'w-6 h-6' }: { className?: string }) {
  return (
...
export function IconMedal({ rank }: { rank: 1 | 2 | 3 }) {
  const colors = {
    1: 'text-gold',
    2: 'text-gray-300',
    3: 'text-amber-600',
  ...
  return (
    <span className={`font-display font-bold text-sm ${colors[rank]}`}>
      {rank}
    </span>
  )
}
...
export function IconTrendUp({ className = 'w-3 h-3' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
...
export function IconTrendDown({ className = 'w-3 h-3' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
...
export function IconRules({ className = 'w-5 h-5' }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75">
